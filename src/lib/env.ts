...
export const env = {
  ...
  photoProofScriptUrl: process.env.EXPO_PUBLIC_PHOTO_PROOF_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbwPCTCryXSWqmGk3TMVkpTJg0vjQENcDoos_cQw4OIHve6rohI5g0PDaBVenGgfLkIpgA/exec',
